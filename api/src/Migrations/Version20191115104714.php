 ...
 */
final class Version20191115104714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, author_id INT DEFAULT NULL, isbn VARCHAR(13) NOT NULL, title VARCHAR(255) NOT NULL, abstract TEXT NOT NULL, publication_date DATE NOT NULL, average_review_rate DOUBLE PRECISION NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
